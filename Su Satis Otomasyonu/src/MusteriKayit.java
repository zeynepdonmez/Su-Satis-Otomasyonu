...
public class MusteriKayit extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Müşteri Kayıt"));
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kayit.png"))); // NOI18N
 ...
 String adi = jTextField1.getText();
        ...
        String telefonno = jTextField3.getText();
        ...
        try {
            ...
            Object a = db.baglan().executeQuery("call musteriekle('"+adi+"','"+soyadi+"','"+telefonno+"','"+adres+"')").toString();
            int sonuc=Integer.parseInt(a.toString().split(" ")[6]);
